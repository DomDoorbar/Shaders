Shader "Custom/Wood"
{
    Properties
    {
        _AlbedoTex ("Wood Texture", 2D) = "white" {}
        _NormalTex ("Normal Wood texture", 2D) = "normal" {}
        _BumpTex ("Bump Wood texture", 2D) = "bump" {}
        _DisplacementTex ("Displacement Wood texture", 2D) = "white" {}
        _Gloss ("Gloss", float) = 1
        _Color ("Color", Color) = (1,1,1,1)
        _AmbientColor ("Ambient Color", Color) = (1,1,1,1)
        _HeightIntensity("Height Intensity", Range(0,0.1)) = 1
